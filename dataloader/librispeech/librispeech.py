...
class LBRS(Dataset):
    ...
    def __init__(self, root='./', phase='train', 
        ...
        self.all_train_df = pd.read_csv("data/librispeech/librispeech_fscil_train.csv")
        self.all_val_df = pd.read_csv("data/librispeech/librispeech_fscil_val.csv")
        self.all_test_df = pd.read_csv("data/librispeech/librispeech_fscil_test.csv")
